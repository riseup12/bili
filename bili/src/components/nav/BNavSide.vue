  ...
  <div class="nav-side"
    ...
    <div class="nav-list"
      ...
      <div v-for="(item,index) in data"
           :key="index">
        <div v-if="isDrag &&index===replaceItem&&replaceItem<=dragId"
             class="n-i sotrable">
          <div class="name"></div>
        </div>
        <div class="n-i sotrable"
      ...
      <li v-if="isDrag && replaceItem===data.length"
          :class="[sortable-item]">
...
.nav-side
    ...
    .n-i
      ...
      &.customize
        ...
        .n-icon-sort
          display block
          margin 0 auto 4px
          background url('../../assets/img/icons.png') -663px -151px no-repeat
          height 18px
          width 18px
      &.drag
        position absolute
  ...
  .gotop
    ...
    .btn_gotop
      height 48px
      background #f6f9fa url('../../assets/img/icons.png') -648px -72px no-repeat
      border 1px solid #e5e9ef
      overflow hidden
      border-radius 4px
  .tip
